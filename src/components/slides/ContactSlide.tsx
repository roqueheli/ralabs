      ...
      <div className="max-w-3xl mx-auto px-8 lg:pl-24 w-full relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 r r4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a
              href="https://wa.me/56992469431?text=Hola%2C%20vengo%20desde%20labs-ra.com%20y%20me%20gustar%C3%ADa%20conversar%20sobre%20un%20proyecto."
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="flex items-center gap-5 mt-10 r r5">
          <a
            href="https://instagram.com/ra_labs_"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[color:var(--text-muted)] hover:text-[var(--cyan)] transition-colors"
          ...
          <a
            href="https://linkedin.com/company/ra-labs"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[color:var(--text-muted)] hover:text-[var(--cyan)] transition-colors"
            aria-label="LinkedIn"
        ...
        <p className="font-mono text-[11px] text-[color:var(--text-muted)] mt-4 r r6">
